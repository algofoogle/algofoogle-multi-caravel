...
# Input delays
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {ui_in[*]}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {ui_in[*]}]
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {uio_in[*]}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {uio_in[*]}]
...
# Input Transition
set_input_transition -max 0.38  [get_ports {ui_in[*]}]
set_input_transition -min 0.05  [get_ports {ui_in[*]}]
set_input_transition -max 0.38  [get_ports {uio_in[*]}]
set_input_transition -min 0.05  [get_ports {uio_in[*]}]
