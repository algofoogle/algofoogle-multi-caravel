...
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {i_mux_io5_reset_enb}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {i_mux_io5_reset_enb}]
...
set_input_transition -max 0.86  [get_ports {i_mux_io5_reset_enb}]
set_input_transition -min 0.07  [get_ports {i_mux_io5_reset_enb}]
...
set_input_transition -min 0.05  [get_ports {trzf_o_vsync}]
set_input_transition -max 0.38  [get_ports {trzf_o_rgb[*]}]
set_input_transition -min 0.05  [get_ports {trzf_o_rgb[*]}]
set_input_transition -max 0.38  [get_ports {trzf_o_tex_csb}]
set_input_transition -min 0.05  [get_ports {trzf_o_tex_csb}]
set_input_transition -max 0.38  [get_ports {trzf_o_tex_sclk}]
