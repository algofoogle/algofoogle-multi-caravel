...
// For safety, these are all configured as inputs, until the SoC firmware changes them
// to suit the respective needs of the active design:
`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL   // SoC: ser_rx (In)
`define USER_CONFIG_GPIO_6_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL   // SoC: ser_tx (Out)
`define USER_CONFIG_GPIO_7_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL   // SoC: irq (In)
...
`define USER_CONFIG_GPIO_36_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL   // SoC: flash_io[2] (I/O)
`define USER_CONFIG_GPIO_37_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL   // SoC: flash_io[3] (I/O)
